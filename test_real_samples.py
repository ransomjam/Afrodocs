#!/usr/bin/env python3
"""
Extract and test formatter on actual sample documents
"""
...
try:
    ...
    for i, (before, after) in enumerate(zip(before_lines, after_lines), 1):
        if before != after:
            ...
            changes += 1
            if changes >= 10:
                print(f"  ... and {len([l for l in before_lines if l]) - 10} more lines potentially changed")
                break
...
# Sample 2
print("\n" + "="*70)
print("[SAMPLE 2] bulleting and numbering sample 2.docx")
print("-" * 70)

doc2_path = r"c:\Users\user\Desktop\PATTERN\Samples\bulleting and numbering sample 2.docx"
try:
    chapter1_text = extract_chapter_one(doc2_path)
    ...
    for i, (before, after) in enumerate(zip(before_lines, after_lines), 1):
        if before != after:
            ...
            changes += 1
            if changes >= 10:
                print(f"  ... and more lines potentially changed")
                break
